# WP16 / MVP21 Locked Non-Releases

以下能力在 `WP16/MVP21` authority freeze 阶段明确 **不放开**：
...
- autonomous outreach
- direct response-plan injection
- direct mutation of `WP7~WP15` owner state
- authority escalation bypass

即使后续 `WP16` 拿到 controlled `E5`，这些 non-releases 也不会自动解锁；必须依赖新的 authority package。
