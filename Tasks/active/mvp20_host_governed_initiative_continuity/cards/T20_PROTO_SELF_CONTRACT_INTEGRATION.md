...
phase: WP15
goal: Connect initiative_self to proto_self_v2 through a bounded, versioned, proposal-only contract.
non_goals:
...
success_criteria:
  - proto_self_v2 reads initiative context through one formal consumer path
  - outputs remain proposal_only with behavioral_authority none
verification_commands:
  - pytest -q OpenEmotion/tests/mvp20/test_initiative_proto_self_integration.py
rollback_point:
  - revert proto_self initiative integration only
```
