# WP15 / MVP20 Initiative Authority Source

## Primary Authority

- parent authority: `Tasks/MVS_task_plan.md`
- phase-detail authority: `Tasks/MVP20_task_plan.md`
...
## Host Substrate Reminder

以下路径可以作为 host execution substrate reference，但不是 `WP15` authority：
...
若 technical reference、host substrate、或历史 evidence 与 `Tasks/MVS_task_plan.md + Tasks/MVP20_task_plan.md` 冲突，以 `Tasks/*` authority 为准。
