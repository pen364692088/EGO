...
class TestOutputSchemaCompliance:
    ...
    def test_error_output(self):
        ...
        assert result["success"] is True  # fallback 返回 true
...
class TestContractFrozen:
    ...
    def test_contract_file_exists(self):
        """测试 contract 文件存在"""
        contract_path = Path(__file__).parent.parent.parent / "modules" / "runtime_metrics_aggregator" / "contract" / "runtime_metrics_aggregator.contract.yaml"
