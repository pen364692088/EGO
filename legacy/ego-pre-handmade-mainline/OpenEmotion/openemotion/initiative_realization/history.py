...
class RealizationRevisionMarker(BaseModel):
    revision_id: str
    timestamp: str
    update_source: str
    trace_reference: str
...
class RealizationRevisionRecord(BaseModel):
    model_version: int
    revision_id: str
    timestamp: str
    update_source: str
    ...
    def to_marker(self) -> RealizationRevisionMarker:
        return RealizationRevisionMarker(
