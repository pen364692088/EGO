...
from .history import ReflectiveRevisionRecord, hash_payload
from .state import ReflectiveSelfState


class ReflectiveReplayError(RuntimeError):
    pass


def replay_state_from_revisions(
    revisions: Iterable[ReflectiveRevisionRecord],
    *,
    base_snapshot: Optional[dict] = None,
) -> Optional[ReflectiveSelfState]:
    ...
    if final_snapshot is None:
        return None
    return ReflectiveSelfState.model_validate(final_snapshot)
