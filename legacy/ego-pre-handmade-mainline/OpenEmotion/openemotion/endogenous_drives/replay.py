...
from .history import DriveRevisionRecord, hash_payload
from .state import DriveState


class DriveReplayError(RuntimeError):
    pass


def replay_state_from_revisions(
    revisions: Iterable[DriveRevisionRecord],
    *,
    ...
    if final_snapshot is None:
        return None
    return DriveState.model_validate(final_snapshot)
