...
SCENARIO_BANK_DIR = ROOT / "OpenEmotion" / "scenarios" / "mvp19_observation_bank"
SCENARIO_MANIFEST_SCHEMA_VERSION = "mvp19.observation_scenario.v1"
...
def load_scenario_manifest(path: str | Path) -> Dict[str, Any]:
    ...
    if errors:
        raise ValueError(f"invalid MVP19 scenario manifest {manifest_path}: {', '.join(errors)}")
    return {
