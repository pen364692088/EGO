...
from mvp17_scenario_bank import (  # noqa: E402
    SCENARIO_MANIFEST_SCHEMA_VERSION,
    load_scenario_bank,
    load_scenario_manifest,
    validate_scenario_manifest,
)
from run_mvp17_controlled_observation_batch import run_controlled_observation_batch  # noqa: E402
...
def test_load_scenario_manifest_rejects_unsupported_source_class(tmp_path):
    ...
    _write_manifest(
        manifest_path,
        {
            ...
            "dialogue_frame_target": "trust_drop_guarded_repair",
...
async def test_batch_controlled_observation_runs_and_aggregates(tmp_path, monkeypatch):
    ...
    _write_manifest(
        bank_dir / "repo_b.json",
        {
            **base_payload,
            ...
            "dialogue_frame_target": "commitment_breach_strict_repair",
        },
    )
    _write_manifest(
        bank_dir / "repo_c.json",
        {
            **base_payload,
            ...
            "dialogue_frame_target": "boundary_caution_repair_hold",
        },
    )
    ...
    async def _fake_run_controlled_observation(**kwargs):
        ...
        return {
            ...
            "trust_commitment_snapshot": {
                "counterpart_id": f"telegram:{scenario['scenario_id']}",
            },
            "social_self_delta": {"surface_reasons": ["trust_drift", "commitment_breach"]},
            "social_writeback": {
                "decision": {"gate_verdict": "allow_writeback"},
                "record": {"revision_id": f"social_rev_{scenario['scenario_id']}"},
            },
        }

    monkeypatch.setattr(
        "run_mvp17_controlled_observation_batch.run_controlled_observation",
    ...
    assert payload["social_proposal_present_count"] == 3
