...
from mvp16_scenario_bank import (  # noqa: E402
    SCENARIO_MANIFEST_SCHEMA_VERSION,
    load_scenario_bank,
    load_scenario_manifest,
    validate_scenario_manifest,
)
from run_mvp16_controlled_observation_batch import run_controlled_observation_batch  # noqa: E402
...
def test_load_scenario_manifest_rejects_unsupported_source_class(tmp_path):
    ...
    _write_manifest(
        manifest_path,
        {
            ...
            "dialogue_frame_target": "continuity_gap_high_growth_pressure",
...
async def test_batch_controlled_observation_runs_and_aggregates(tmp_path, monkeypatch):
    ...
    _write_manifest(
        bank_dir / "repo_b.json",
        {
            **base_payload,
            ...
            "dialogue_frame_target": "stagnation_high_identity_guard",
        },
    )
    _write_manifest(
        bank_dir / "repo_c.json",
        {
            **base_payload,
            ...
            "dialogue_frame_target": "drive_reflection_conflict_with_governed_adaptation",
        },
    )
    ...
    async def _fake_run_controlled_observation(**kwargs):
        ...
        return {
            "status": "pass",
            "replay_valid": True,
            "developmental_proposal_present": True,
            ...
            "developmental_self_delta": {"surface_reasons": ["continuity_gap", "growth_pressure"]},
            "developmental_writeback": {
                "decision": {"gate_verdict": "allow_writeback"},
                "record": {"revision_id": f"developmental_rev_{scenario['scenario_id']}"},
            },
        }

    monkeypatch.setattr(
        "run_mvp16_controlled_observation_batch.run_controlled_observation",
    ...
    assert payload["developmental_proposal_present_count"] == 3
