...
from mvp14_scenario_bank import (  # noqa: E402
    SCENARIO_MANIFEST_SCHEMA_VERSION,
    load_scenario_bank,
    load_scenario_manifest,
    validate_scenario_manifest,
)
from run_mvp14_controlled_observation_batch import run_controlled_observation_batch  # noqa: E402
...
def test_load_scenario_manifest_rejects_unsupported_source_class(tmp_path):
    ...
    _write_manifest(
        manifest_path,
        {
            ...
            "dialogue_frame_target": "maintenance_gap",
...
async def test_batch_controlled_observation_runs_and_aggregates(tmp_path, monkeypatch):
    ...
    _write_manifest(
        bank_dir / "repo_a.json",
        {
            ...
            "dialogue_frame_target": "replay_debt_under_low_reserve",
            "messages": ["a", "b", "c"],
            "idle_seconds": 900.0,
    ...
    _write_manifest(
        bank_dir / "repo_b.json",
        {
            ...
            "license_note": "repo authored",
            "dialogue_frame_target": "existing_debt_with_continuity_imbalance",
            "messages": ["a", "b", "c"],
            "idle_seconds": 900.0,
            "maintenance_debts": [{"category": "continuity_repair", "amount": 0.55, "priority": 0.9}],
        },
    )
    _write_manifest(
        bank_dir / "repo_c.json",
        {
            ...
            "license_note": "repo authored",
            "dialogue_frame_target": "repair_pressure_with_governed_maintenance",
            "messages": ["a", "b", "c"],
            "idle_seconds": 900.0,
            "drive_overrides": {"repair": 0.82},
        },
    )
    ...
    async def _fake_run_controlled_observation(**kwargs):
        ...
        return {
            ...
            "endogenous_drive_writeback": {
                ...
                "record": {"revision_id": f"drive_rev_{scenario['scenario_id']}"},
            },
        }

    monkeypatch.setattr(
        "run_mvp14_controlled_observation_batch.run_controlled_observation",
    ...
    assert payload["maintenance_candidate_present_count"] == 3
