...
| 2026-04-03 | `WP9/MVP14` 已按 docs-first 方式启动：当前只冻结 capability ownership、authority source、IO contract、`WP8` boundary freeze 与 locked non-releases；不直接开启 `MVP14` 代码实现，也不因 `WP8 pass` 放开 OpenEmotion direct reply 或 broader transport claims |
