# Proto-Self V2 Artifact Index

## Current Snapshot

- default subject writeback mainline:
  - `proto_self.v2`
- compatibility fallback:
  - session-scoped `v1` only
...
- real-channel first failed attempt:
