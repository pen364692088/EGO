...
class InitiativeRevisionMarker(BaseModel):
    revision_id: str
    timestamp: str
    update_source: str
    trace_reference: str
...
class InitiativeRevisionRecord(BaseModel):
    model_version: int
    revision_id: str
    timestamp: str
    update_source: str
    ...
    def to_marker(self) -> InitiativeRevisionMarker:
        return InitiativeRevisionMarker(
