...
from .history import InitiativeRevisionRecord, hash_payload
from .state import InitiativeSelfState


class InitiativeReplayError(RuntimeError):
    pass


def replay_state_from_revisions(
    revisions: Iterable[InitiativeRevisionRecord],
    *,
    base_snapshot: Optional[dict] = None,
) -> Optional[InitiativeSelfState]:
    ...
    if final_snapshot is None:
        return None
    return InitiativeSelfState.model_validate(final_snapshot)
