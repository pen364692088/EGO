...
def _default_traffic_source_for_observation_source(observation_source: str) -> str:
    mapping = {
        "direct_real": "real",
        "pytest": "synthetic",
        "testbot": "synthetic",
...
def _resolve_shadow_sources(
    ...
    if resolved_traffic_source == "unknown":
        resolved_traffic_source = _default_traffic_source_for_observation_source(
...
class SelfReportConsistencyChecker:
    ...
    def check_consistency(
        ...
        Args:
            ...
            traffic_source: Optional traffic classification for shadow observation
            observation_source: Optional observation source for shadow observation
        ...
        resolved_traffic_source, resolved_observation_source = _resolve_shadow_sources(
