...
- 当前主体层 state writeback 主线按最新 authority 已收敛到 **Proto-Self Kernel v2**
- `v1` 如保留，只作为兼容 fallback，不再是默认 owner
...
| `openemotion/proto_self_v2/` | V2 主体层 writeback mainline implementation；V1 仅保留兼容 fallback |
